...
import static in.zeta.aether.spring.initializr.constant.AppConstant.ZETA_SPRING_COMMON_BASE_PACKAGE;
...
public class MainClassProjectGenerationConfiguration {
  ...
  public MainClassProjectGenerationConfiguration(ProjectDescription description) {
    ...
    mainApplicationAnnotations.add(ZETA_SPRING_COMMON_BASE_PACKAGE);
