package in.zeta.aether.spring.initializr;
...
class SimpleGenerator {
  ...
  Path generateProject(ProjectDescription description) {
    ...
    ProjectAssetGenerator<Path> projectAssetGenerator =
        new DefaultProjectAssetGenerator(
            (resolvedDescription) ->
                Paths.get("target/projects", "project-" + formatter.format(LocalDateTime.now())));
